...
pubDate: 2023-02-08
description: My experience and learning from creating eraser function
---

import splitting from './splitting.png'
import clipWithLine from './clip-with-line.png'
import clipWithRect from './clip-with-rect.png'
import intersecting from './intersecting.png'
import closeToShape from './close-to-shape.png'
...
<img src={intersecting} alt="Case where the eraser is intersecting a shape"/>
...
<img src={closeToShape} alt="Case where the eraser is not interscting but close enough to delete a shape"/>
...
<img src={clipWithLine} alt="Line clipping with line" />

When erasing a rectangle shape, then it would be like this.

<img src={clipWithRect} alt="Line clipping with rectanble" />
