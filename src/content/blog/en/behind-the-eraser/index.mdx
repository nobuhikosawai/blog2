...
<Image src={intersecting} alt="Case where the eraser is intersecting a shape" />
...
<Image
  src={closeToShape}
  alt="Case where the eraser is not interscting but close enough to delete a shape"
/>
...
<Image src={clipWithLine} alt="Line clipping with line" />

When erasing a rectangle shape, then it would be like this.

<Image src={clipWithRect} alt="Line clipping with rectanble" />
