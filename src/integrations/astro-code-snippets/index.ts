// copied from https://github.com/withastro/docs/blob/3d66ba6dd4ba30ec0dffe02bfa638fe20c61f583/integrations/astro-code-snippets.ts
...
import { isMDXFile } from './isMDX';
import { makeComponentNode } from './makeComponentNode';

const CodeSnippetTagname = 'AutoImportedCodeSnippet';
export const codeSnippetAutoImport: Record<string, [string, string][]> = {
  './src/integrations/astro-code-snippets/CodeSnippet.astro': [
